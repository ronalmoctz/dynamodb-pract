...
def print_sales_summary(df: pd.DataFrame, title: str = "Sales Summary") -> None:
    ...
    if not available_cols:
        print("⚠️  Sales columns not found\n")
        return
...
def print_full_report(df: pd.DataFrame) -> None:
    ...
    if numeric_issues:
        ...
        print(f"\n⚠️  Numeric column issues (coercion):")
        print(tabulate(issues_table, headers='keys', tablefmt='grid'))
    else:
        print("\n✅ Critical numeric columns OK")
    ...
    if date_issues:
        ...
        print(f"\n⚠️  Date column issues:")
        print(tabulate(date_table, headers='keys', tablefmt='grid'))
    else:
        if date_candidates:
            print("\n✅ Critical date columns OK")

    # Duplicates
    if dup_count:
        print(f"\n⚠️  Duplicates: {dup_count:,} (showing 3)")
